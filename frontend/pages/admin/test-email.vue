    ...
    <div class="grid-2 gap-6">
      ...
      <div class="card card-padded">
        ...
        <div v-if="testResponseStatus" class="mb-4">
          ...
          <div v-if="testResponseData" class="p-3 bg-dark-slate rounded-10 text-xs font-mono overflow-x-auto mt-3">
            <pre class="m-0 whitespace-pre-line break-all">{{ JSON.stringify(testResponseData, null, 2) }}</pre>
          </div>
        </div>
