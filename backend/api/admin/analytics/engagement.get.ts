// backend/api/admin/analytics/engagement.get.ts
import { defineEventHandler, getQuery } from 'h3'
import { requirePermission } from '../../../utils/authGuard'
import { getEngagementAdoption, AdminAnalyticsFilter } from '../../../utils/analyticsAdminService'
...
export default defineEventHandler(async (event) => {
  ...
  return await getEngagementAdoption(filter)
})
