// backend/api/admin/analytics/overview.get.ts
import { defineEventHandler, getQuery } from 'h3'
import { requirePermission } from '../../../utils/authGuard'
import { getAdminOverview, AdminAnalyticsFilter } from '../../../utils/analyticsAdminService'
...
export default defineEventHandler(async (event) => {
  ...
  return await getAdminOverview(filter)
})
