// backend/api/admin/analytics/funnel.get.ts
import { defineEventHandler, getQuery } from 'h3'
import { requirePermission } from '../../../utils/authGuard'
import { getAcquisitionFunnel, AdminAnalyticsFilter } from '../../../utils/analyticsAdminService'
...
export default defineEventHandler(async (event) => {
  ...
  return await getAcquisitionFunnel(filter)
})
