// backend/api/admin/analytics/invoicing.get.ts
import { defineEventHandler, getQuery } from 'h3'
import { requirePermission } from '../../../utils/authGuard'
import { getInvoicingIntelligence, AdminAnalyticsFilter } from '../../../utils/analyticsAdminService'
...
export default defineEventHandler(async (event) => {
  ...
  return await getInvoicingIntelligence(filter)
})
