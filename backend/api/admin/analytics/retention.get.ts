// backend/api/admin/analytics/retention.get.ts
import { defineEventHandler, getQuery } from 'h3'
import { requirePermission } from '../../../utils/authGuard'
import { getRetentionHeatmap, AdminAnalyticsFilter } from '../../../utils/analyticsAdminService'
...
export default defineEventHandler(async (event) => {
  ...
  return await getRetentionHeatmap(filter)
})
